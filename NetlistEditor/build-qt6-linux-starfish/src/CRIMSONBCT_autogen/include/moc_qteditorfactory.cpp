...
#include <memory>
#include "../../../../src/gui/qtsolutions/qtpropertyeditor/qteditorfactory.h"
...
Q_CONSTINIT static const qt_meta_stringdata_QtLineEditFactory_t qt_meta_stringdata_QtLineEditFactory = {
    {
        ...
        QT_MOC_LITERAL(69, 7),  // "QRegExp"
        QT_MOC_LITERAL(77, 12),  // "slotSetValue"
        QT_MOC_LITERAL(90, 19)   // "slotEditorDestroyed"
    },
    "QtLineEditFactory",
    "slotPropertyChanged",
    "",
...
void QtLineEditFactory::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->d_func()->slotRegExpChanged((*reinterpret_cast< std::add_pointer_t<QtProperty*>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QRegExp>>(_a[2]))); break;
