...
#include <memory>
#include "../../../../src/gui/qtsolutions/qtpropertyeditor/qtpropertymanager.h"
...
Q_CONSTINIT static const qt_meta_stringdata_QtStringPropertyManager_t qt_meta_stringdata_QtStringPropertyManager = {
    {
        ...
        QT_MOC_LITERAL(77, 7),  // "QRegExp"
        QT_MOC_LITERAL(85, 6),  // "regExp"
        QT_MOC_LITERAL(92, 8),  // "setValue"
        QT_MOC_LITERAL(101, 9)   // "setRegExp"
    },
...
void QtStringPropertyManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->regExpChanged((*reinterpret_cast< std::add_pointer_t<QtProperty*>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QRegExp>>(_a[2]))); break;
        ...
        case 3: _t->setRegExp((*reinterpret_cast< std::add_pointer_t<QtProperty*>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QRegExp>>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
