...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_qsapecng__ExtendedMdiArea_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_qsapecng__ExtendedMdiArea_t qt_meta_stringdata_qsapecng__ExtendedMdiArea = {
    {
        QT_MOC_LITERAL(0, 25),  // "qsapecng::ExtendedMdiArea"
        QT_MOC_LITERAL(26, 13),  // "dropFileEvent"
        QT_MOC_LITERAL(40, 0),  // ""
        QT_MOC_LITERAL(41, 8)   // "fileName"
    },
    "qsapecng::ExtendedMdiArea",
    "dropFileEvent",
    "",
    "fileName"
};
...
Q_CONSTINIT static const uint qt_meta_data_qsapecng__ExtendedMdiArea[] = {
...
Q_CONSTINIT const QMetaObject qsapecng::ExtendedMdiArea::staticMetaObject = { {
    QMetaObject::SuperData::link<QMdiArea::staticMetaObject>(),
    qt_meta_stringdata_qsapecng__ExtendedMdiArea.offsetsAndSizes,
    qt_meta_data_qsapecng__ExtendedMdiArea,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_qsapecng__ExtendedMdiArea_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<ExtendedMdiArea, std::true_type>,
        // method 'dropFileEvent'
...
void qsapecng::ExtendedMdiArea::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->dropFileEvent((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &ExtendedMdiArea::dropFileEvent; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
