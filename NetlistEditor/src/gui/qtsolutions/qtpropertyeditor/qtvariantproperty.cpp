...
#ifndef qVariantValue
#define qVariantValue qvariant_cast
#endif

#if QT_VERSION >= QT_VERSION_CHECK(6, 0, 0)
template <class T>
static void qVariantSetValue(QVariant &variant, const T &value)
{
...
template <class T>
static QList<T> qFindChildren(const QObject *object)
{
    return object->findChildren<T>();
}
