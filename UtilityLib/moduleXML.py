...
def writeNetworkToXML(vascularNetwork, dataNumber = "xxx", networkXmlFile = None):
    ...
    for xmlElementName in nxmlW.xmlElements:
        ...
        if xmlElementName == 'boundaryConditions':
            for vesselId,boundaryConditions in vascularNetwork.boundaryConditions.items():
            ...
            for comId,comData in vascularNetwork.communicators.items():
            ...
            for stimulusId, stimulus in vascularNetwork.externalStimuli.items():
