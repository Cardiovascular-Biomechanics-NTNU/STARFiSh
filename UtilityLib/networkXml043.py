...
boundaryConditionElements = {
          ...
          'Resistance'                  :['Rc'],
          'Netlist'                     :['surfaceId','flowSign','Rtilde','S'],
          ...
          'Flow-FromFile'               :['ampConst','Tpulse','filePathName','prescribe'],
          'L-network'                   :['Z','C'],
          ...
          '_Flow-FromFile'              :['ampConst','Tpulse','filePathName','prescribe'],
          ...
          '_Resistance'                 :['Rc'],
          '_Netlist'                    :['surfaceId','flowSign','Rtilde','S'],
