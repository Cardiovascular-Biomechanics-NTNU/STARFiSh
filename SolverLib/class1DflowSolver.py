...
class FlowSolver(cSBO.StarfishBaseObject):
        ...
        if self.output['CFLcorrect'] != []:
            ...
            if automaticGridCorrection != {}:
                ...
                if gridCorrection in (' ','','y','Y'):
                    ...
                    arrayN = 0
                    for vesselId,Nnew in automaticGridCorrection.items():
                        ...
                        arrayN = arrayN+1
        gridNodes = 0
        for vessel in self.vascularNetwork.vessels.values():
            gridNodes += vessel.N
    ...
    def initializeBoundarys(self):
        ...
        if len(self.vessels) == 1:
            ...
            for vesselId,boundaryConditions in self.vascularNetwork.boundaryConditions.items():
    ...
    def initializeCommunicators(self):
        ...
        for comId, comData in self.vascularNetwork.communicators.items():
    ...
    def MacCormack_Field(self):
        ...
        if BVcheck == True:
            ...
            totalIn = 0
            totalOut = 0
            for boundaryList in self.boundarys.values():
